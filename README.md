...
Unlike conventional image-domain motion correction, this pipeline isolates the pure electrodynamic effects (coil-sample interaction) by calculating the intrinsic sensitivity variability ($\lambda^\ast$) and intrinsic thermal-noise variability ($\alpha^\ast$) using a generalized Huygens-surface approach.
