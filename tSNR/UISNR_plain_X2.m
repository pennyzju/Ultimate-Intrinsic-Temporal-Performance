...
for i = 1:length(angle_matrix)
    ...
    p = 117;
        ...
        [usnr_map,b1_map,loss_map]=compute_usnr_unacc_fast_v4(B1m,LOSS,usnr_mask_pan,idxS);
        ...
        save(Xout_file3, 'usnr_mask_pan');  % 默认保存格式

        usnr_map_correction= shift_nonzero_region(usnr_map,flag, -angle_matrix(i));
        ...
        loss_map_correction= shift_nonzero_region(loss_map,flag, -angle_matrix(i));
