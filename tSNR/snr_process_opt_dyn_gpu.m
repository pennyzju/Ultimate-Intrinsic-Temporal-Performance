function snr_process_opt_dyn_gpu(B0,subdir, flag, angle_matrix)
    % folderpath: 输出根目录
    ...
    %% 添加路径
        paths = {
            ...
            '/data/jletpubiaxinli/projects/20240728_my-repo_test/unaccelerated_matlab'
    ...
    for i = 1:length(angle_matrix)
        ...
        [usnr_map, b1_map, loss_map, rf_rate, rf_map] = compute_usnr_unacc_fast_v6(B1m, LOSS, usnr_mask_rot, idxS);
