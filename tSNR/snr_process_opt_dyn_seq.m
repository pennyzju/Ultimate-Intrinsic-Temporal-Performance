function snr_process_opt_dyn_seq(B0,subdir, flag, angle_matrix,seqlist)
    % folderpath: 输出根目录
    ...
    for i = 1:length(angle_matrix)
        ...
        for seq = seqlist
            ...
            [usnr_map, b1_map, loss_map, rf_rate, rf_map] = compute_usnr_unacc_fast_v5(B1mseq, LOSSseq, usnr_mask_rot, idxS);
