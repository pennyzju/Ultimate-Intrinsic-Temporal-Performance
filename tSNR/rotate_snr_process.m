function rotate_snr_process(B0, flag, angle_matrix,subdir)
    ...
    for angle = angle_matrix
        ...
        [usnr_map, b1_map, loss_map] = compute_usnr_sos(data.B1m, LOSS, usnr_mask_rot, data.idxS);
...
function data = load_all_files(subFolderPath)
    cd(subFolderPath);
