...
for i = 1:length(angle_matrix)
    ...
    p = 117;
        ...
        [usnr_map, b1_map, loss_map, rf_rate, g_factor, rf_all]=compute_usnr_CPU_v4_sol(B1m,LOSS,usnr_mask_pan,idxS);
        ...
        for k = 1:size(save_items, 1)
            ...
            outfile = fullfile(FolderPath, subfolder, sprintf('test_%s_%s_%d.mat', prefix, flag, angle_matrix(i)));
        ...
        for k = 1:size(correction_items, 1)
            ...
            outfile = fullfile(FolderPath, subfolder, sprintf('test_%s_%s_%d_correction.mat', prefix, flag, angle_matrix(i)));
