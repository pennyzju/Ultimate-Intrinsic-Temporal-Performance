function snr_process_opt_dyn_diagcoilloss(B0,subdir, flag, angle_matrix)
    % folderpath: 输出根目录
    ...
    for i = 1:length(angle_matrix)
        ...
        [usnr_map, b1_map, loss_map, rf_rate, rf_map] = compute_usnr_unacc_fast_v5(B1m, totLOSS, usnr_mask_rot, idxS);
