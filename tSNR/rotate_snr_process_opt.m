function rotate_snr_process_opt(B0, flag, angle_matrix,subdir)
    if B0 == 7
    ...
    for angle = angle_matrix
        ...
        %[usnr_map, b1_map, loss_map, rf_rate] = compute_sos_snr_general(data.B1m, LOSS, usnr_mask_rot, data.idxS);
