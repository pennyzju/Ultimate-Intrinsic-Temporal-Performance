function ubasis_comp_fields_dipole(public_out_dir,out_dir,fileName)
    ...
    Sig = sigma_e(object_def.idxS);
    Rho = rho(object_def.idxS);
    
    SigN = sigma_e(object_def.idxN);
    RhoN = rho(object_def.idxN);
