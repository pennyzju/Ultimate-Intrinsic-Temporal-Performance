function ubasis_comp_fields_new(public_out_dir,out_dir,fileName)
    ...
    Sig = pan_sigma_e(object_def.idxS);
    Rho = pan_rho(object_def.idxS);
    
    SigN = pan_sigma_e(object_def.idxN);
    RhoN = pan_rho(object_def.idxN);
