function Angle2_compute_alpha_wo_strict_range(B0, subdir, flag, seq_list)
...
% 4. 处理: 剔除 0 和 NaN (Masking)
    ...
    %if nargin < 4, seq_list = [20:20:100,200,400,800,1000,1200,1500,2000,2200,2500]; end
    ...
    for s = 1:num_seqs
        ...
        %% 5. Save Results
        outfile = sprintf('Angle2_alpha_wo_%s_%d.mat', flag, current_seq);
