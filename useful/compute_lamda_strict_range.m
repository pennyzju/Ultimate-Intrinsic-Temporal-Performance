function compute_lamda_strict_range(B0, subdir, flag, seq_list)
...
% 4. 处理: 剔除 0 和 NaN (Masking), 计算 Lamda = Std / Mean
    ...
    if nargin < 4, seq_list = [ 100, 200, 400, 800, 1000, 1200, 1500, 2000, 2200]; end
    ...
    fprintf('Starting strict Lamda processing (NO BASE ADDED) for %d sequences...\n', num_seqs);
