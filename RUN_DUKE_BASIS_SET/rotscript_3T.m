...
%  COMPUTATION OPTIONS
public_out_dir = '/data/jiaxinli/projects/20241101_3T_UISNR_output/public';%结果输出目录
...
% create default configuration options
    default_config_3(public_out_dir);
end
...
out_dir = '/data/jiaxinli/projects/20241101_3T_UISNR_output/';%结果输出目录
% 检查目录是否存在，如果不存在则创建它
...
flag = 'rot'; % 'left' or 'rot' or 'front';
angle_deg =5;
% 生成从 -angle 到 angle，间隔为 1 度的角度矩阵
angle_matrix =0 :1:angle_deg;
