...
function [usnr_map,b1_map,loss_map,rf_rate]=compute_usnr_unacc_fast_v3_GAO_noParallel(B1m,LOSS,mask,idxS)
...
% 创建新掩码：同时满足 mask 非零 且至少一个 b1maps 通道非零
b1_nonzero = any(b1maps ~= 0, 4);
mask_new = mask & b1_nonzero;
