...
function ubasis_comp_inc_basis

clear all;  % this is to avoid Matlab virtual storage
load ubasis_options;

log_filename = sprintf('%s/LOG_comp_inc_fiels.txt',out_dir);
fid = fopen(log_filename,'w');
tini = tic;
   

gamma = 42.576e6;  % 1T frequency
