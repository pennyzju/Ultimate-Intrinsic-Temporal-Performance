function [Gp_mn] = Circulant(G_mn)
%%
[L, M, N, ~] = size(G_mn);
%
Gp_mn = zeros(2*L,2*M,2*N ,6);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Cube 'L'
[Gp_coeff_L] = Gperiodic_coeff('L');
% Cube 'M'
[Gp_coeff_M] = Gperiodic_coeff('M');
% Cube 'N'
[Gp_coeff_N] = Gperiodic_coeff('N');
% Cube 'LM'
[Gp_coeff_LM] = Gperiodic_coeff('LM');
% Cube 'LN'
[Gp_coeff_LN] = Gperiodic_coeff('LN');
% Cube 'MN'
[Gp_coeff_MN] = Gperiodic_coeff('MN');
% Cube 'LMN' equal to 1
